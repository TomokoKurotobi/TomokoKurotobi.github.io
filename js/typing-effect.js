...
async function typeBackground() {
    ...
    const typing_list = [
        ...
        {contents: console_text_prefix, typingSpeed: 0, timeout: 0, break: false},
        {contents: 'cat information.txt', typingSpeed: 50, timeout: 500, break: true},
        ...
        {contents: 'Computer Languages: C++, Python, JavaScript', typingSpeed: 0, timeout: 0, break: true},
        {contents: 'Framework: CUDA SDK, OpenCV, Qt, React.js', typingSpeed: 0, timeout: 0, break: true},
        {contents: 'Tools: Git, CMake, VS concurrency Visualizer, NVIDIA Nsight Systems', typingSpeed: 0, timeout: 0, break: true},
        {contents: 'Troubleshooting, Debugging, Code Optimization', typingSpeed: 0, timeout: 0, break: true},
        {contents: console_text_prefix, typingSpeed: 0, timeout: 0, break: false},
        {contents: 'echo "#include &lt;iostream&gt;\nint main(){std::cout << "Hello, World!" << std::endl; return 0;}" > hello.cpp', typingSpeed: 50, timeout: 500, break: true},
        {contents: console_text_prefix, typingSpeed: 0, timeout: 0, break: false},
        {contents: 'g++ hello.cpp -o hello', typingSpeed: 50, timeout: 500, break: true},
        {contents: console_text_prefix, typingSpeed: 0, timeout: 0, break: false},
    ...
    for (let i = 0; i < typing_list.length; i++) {
        ...
        await typingEffect(target_id, console_text, text.contents, text.typingSpeed, text.timeout);
